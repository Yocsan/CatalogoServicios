...
function Footer()
{
    ...
    $this->Cell(0,10,utf8_decode('Gerencia de Tecnología y Soluciones                 pagina '.$this->PageNo().'/{nb}'.$image),1,1,'C');
...
function FancyTable($header, $data)
{
    ...
    {
        $this->SetXY(40, 55); //40 = 10 posiciónX_anterior + 30ancho Celdas de cabecera
