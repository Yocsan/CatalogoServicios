 ...
 */
/*
 $config['ldap_uri'] = array('ldap://161.196.109.214:389');
// 
 $config['dn']='DC=labcantv,DC=com,DC=ve';
 $config['use_tls'] = false; // Encrypted without using SSL
 $config['search_base'] = array('DC=labcantv,DC=com,DC=ve');
 $config['user_search_base'] = "";  // Leave empty to use $config['search_base']
 $config['group_search_base'] = "";  // Leave empty to use $config['search_base']
 ...
 */
   ...
   $config['ldap_uri'] = array("LDAP://alpha03");
   $config['domain']= '@cantv.com.ve';
   $config['use_tls'] = false;  // Using SSL above, don't use TLS with it
   $config['search_base'] = "DC=cantv,DC=com,DC=ve";
   ...
   $config['proxy_user'] = 'yburgo02@cantv.com.ve'; // Or CN=ProxyUser,CN=Users,DC=mycompany,DC=com
   $config['proxy_pass'] = 'Cantv100';
   $config['roles'] = array(1 => 'User', 
                          3 => 'Power User',
                          5 => 'Administrator');
