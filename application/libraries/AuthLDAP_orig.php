...
class AuthLDAP {
    ...
    private function _authenticate($username, $password) {        
        ...
        if($this->proxy_user) {
            $bind = ldap_bind($this->ldapconn, $this->proxy_user.'@cantv.com.ve', $this->proxy_pass);
        }else {
            $bind = ldap_bind($this->ldapconn,$username.'@cantv.com.ve',$password);
        }
        ...
        //	var_dump($usb);
            $search = ldap_search($this->ldapconn, $usb, $filter, 
                array('OU', $this->login_attribute, 'DC'));
