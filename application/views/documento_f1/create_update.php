...
<div class="row">
     ...
     <legend>Informaci&oacute;n general del F1</legend>
     		     	
     <form  id="frm_create_etf" action="<?php echo base_url('documento_f1/generar_documento')?>">  
   	          
       	<div class="row">
       		<div class="form-group col-xs-12">
       			<input type="submit" class="btn btn-default" name="generar_etf" id="generar_etf" value="Generar documento word"/>	
       		</div>
       	</div>
