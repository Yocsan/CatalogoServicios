...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 17-11-2017 a las 01:17:30
...
(9, 'FDGSDFG', 'fdsgfg', 1),
(10, 'ASDFSD', 'fsadf', 1),
(11, 'ASDFSDFSD', 'asdfsd', 0),
(12, 'SDFASD', 'asdfdf', 1),
(13, 'ADSF', 'sdfaf', 1),
(14, 'ASDF', 'ad', 0),
(15, 'AP', 'Aprovisionamiento', 1);
...
--
ALTER TABLE `conf_web`
  MODIFY `id_conf_web` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
--
...
--
ALTER TABLE `necesidades`
  MODIFY `id_necesidad` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=23;
--
-- AUTO_INCREMENT de la tabla `premisas`
--
ALTER TABLE `premisas`
  MODIFY `id_premisa` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
--
