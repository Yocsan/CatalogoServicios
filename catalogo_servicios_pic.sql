...
--
-- Servidor: localhost
-- Tiempo de generación: 08-12-2017 a las 19:26:30
...
CREATE TABLE IF NOT EXISTS `estructuras_datos_f1` (
...
(18, 'Frecuencias', '3', 'frecuencias', '', '1'),
(19, 'Frecuencias de ftp', '3', 'frecuencias_ftp', '', '1'),
(20, 'Modelo de Datos', '3', 'modelo_datos', '', '1'),
(21, 'Procesamientos', '3', 'procesamientos', '', '1'),
(22, 'Reglas de Transporte', '3', 'reglas_transporte', '', '1'),
(23, 'Sentidos', '3', 'sentidos', '', '1'),
(24, 'Tipos de Necesidad', '3', 'tipos_necesidad', '', '1');
...
(6, 'prueba', 'prueba', 'Prueba', 'prueba', '564654', '464564', '5644565645', 1, 1);
...
) ENGINE=InnoDB AUTO_INCREMENT=16 DEFAULT CHARSET=latin1 COMMENT='Procesos de negocios de la corporacion asociados a funcionalidades.';
...
--
ALTER TABLE `frecuencias`
  MODIFY `id_frecuencia` int(5) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=17;
--
...
--
ALTER TABLE `necesidades`
  MODIFY `id_necesidad` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=74;
--
